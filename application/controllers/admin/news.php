...
class News extends CI_Controller
{
    ...
    public function view($message = null)
    {
        ...
        $list = $this->News_Model->get_all_items();
        $data['page_title'] = 'Quản lý bài viết';
        $data['list'] = $list;
        $this->template->write_view("content", "admin/news/news_list", $data);
    ...
    public function edit($id = null)
    {
        ...
        if ($id === null) {
            ...
            $data['info'] = $this->News_Model->get_items_info($id);
        }
        ...
        $this->template->write_view("content", "admin/news/news_edit", $data);
        $this->template->render();
    }
