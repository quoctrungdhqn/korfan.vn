...
class Multi_menu {
    ...
    private $menu_label_en               = 'name_en';

    private $menu_label_de               = 'name_de';
    ...
    public function render_en($config = array(), $divided_items_list = array(), $divider = '')
    {
        $html  = "";
        ...
        if ( count($this->items) )
        {
            ...
            $this->render_item_en($items, $html);
        }

        return $html;
    }

    public function render_de($config = array(), $divided_items_list = array(), $divider = '')
    {
        $html  = "";
        ...
        if ( count($this->items) )
        {
            ...
            $this->render_item_de($items, $html);
        }
    ...
    private function render_item_en($items, &$html = '')
    {
        if ( empty($html) )
        {
            $nav_tag_opened = true;
        ...
        {
            // menu label
            if ( isset($item[$this->menu_label_en], $item[$this->menu_key]) )
            {
                $label = $item[$this->menu_label_en];
                ...
                if ( $has_children )
                {
                    $this->render_item_en($item['children'], $html);
    ...
    private function render_item_de($items, &$html = '')
    {
        if ( empty($html) )
        {
            $nav_tag_opened = true;
        ...
        {
            // menu label
            if ( isset($item[$this->menu_label_de], $item[$this->menu_key]) )
            {
                $label = $item[$this->menu_label_de];
