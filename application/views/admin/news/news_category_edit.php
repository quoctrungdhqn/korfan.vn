...
<div class="col-lg-12">
    <div class="panel panel-default bootstrap-admin-no-table-panel">
        ...
        <form class="form-horizontal" role="form" action="<?php echo base_url() ?>admin/news_category/save_update/"
            ...
            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="home">
                        <fieldset>
                            <legend>
                                ...
                                <a href="<?php echo base_url() ?>admin/news_category/view/"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <?php echo form_dropdown('parents', $select, @$info->parents, 'class="form-control"'); ?>
                                </div>
                            </div>
                            <!--<div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-lg-2 control-label" for="typeahead">Bật/Tắt</label>
                                <div class="col-lg-10">
                ...
                <button type="submit" class="btn btn-primary">Lưu thay đổi</button>
                <a href="<?php echo base_url() ?>admin/news_category/view" class="btn btn-danger">Hủy</a>
            </div>
