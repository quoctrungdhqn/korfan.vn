...
<div class="col-lg-12">
    <div class="panel panel-default bootstrap-admin-no-table-panel">
        ...
        <form class="form-horizontal" role="form" action="<?php echo base_url() ?>admin/news/save_update" method="post"
                    ...
                    <div role="tabpanel" class="tab-pane active" id="home">
                        <fieldset>
                            <legend>
                                ...
                                <a href="<?php echo base_url() ?>admin/news/view" class="btn btn-danger">Hủy</a>
                            </legend>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <?php echo form_dropdown('id_category', $select, @$info->id_category, 'class="form-control"'); ?>
                                </div>
                            </div>
                            <div class="form-group">
