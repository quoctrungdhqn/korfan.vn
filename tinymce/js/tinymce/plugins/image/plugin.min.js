tinymce.PluginManager.add("image", function(e) {
    function openmanager() {
        ...
        var urlh = $(location).attr('hostname');
        //alert(urlh);
        win = e.windowManager.open({
            title: 'Image Manager',
            data: data,
            classes: 'filemanager',
            file: 'http://'+urlh+'/filemanager/dialog.php?type=1&editor=' + e.id + '&lang=' + tinymce.settings.language + '&subfolder=' + tinymce.settings.subfolder,
            filetype: 'image',
            width: 900,
            height: 600,
            inline: 1
